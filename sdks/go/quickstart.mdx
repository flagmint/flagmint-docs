...
<CardGroup cols={2}>
  <Card title="Configuration" href="/sdks/go/configuration">
    All `With*` options, endpoint overrides, and logger setup
  </Card>
  <Card title="Local Evaluation" href="/sdks/go/local-evaluation">
    Evaluate flags in-process — no network round-trip
  </Card>
  <Card title="Transport" href="/sdks/go/transport">
    WebSocket vs HTTP, reconnection, and fallback behaviour
  </Card>
  <Card title="Caching" href="/sdks/go/caching">
