...
<CardGroup cols={2}>
  ...
  <Card title="Targeting Rules" icon="bullseye" href="/api-reference/flag-targeting-rules/list-targeting-rules">
    Define sophisticated user targeting
  </Card>
  <Card title="Segments" icon="users" href="/api-reference/segments/list-segments">
