...
See [Transport](/sdks/go/transport) for a detailed comparison.
...
See [Local Evaluation](/sdks/go/local-evaluation) for a full guide.
...
See [Caching](/sdks/go/caching) for the `CacheAdapter` interface and examples.
